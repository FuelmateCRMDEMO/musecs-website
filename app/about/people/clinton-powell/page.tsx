...
export const metadata: Metadata = {
  title: 'Clinton Powell - Founder & Managing Director | MuseCS',
  description: 'Clinton Powell is the Founder & Managing Director of Muse Consultancy Services, specializing in enterprise software architecture, legacy modernization, and senior engineering talent evaluation.',
  alternates: {
    canonical: 'https://www.musecs.com/about/people/clinton-powell/'
  }
};

export default function ClintonPowellProfilePage() {
  const personSchema = {
    '@context': 'https://schema.org',
    '@type': 'Person',
    '@id': 'https://www.musecs.com/about/people/clinton-powell/#person',
    'name': 'Clinton Powell',
      ...
      <section className="pt-16 pb-16 px-6 border-b border-gray-800 bg-gradient-to-b from-[#080808] to-[#050505]">
        <div className="max-w-7xl mx-auto space-y-6">
          <Breadcrumbs items={[
            ...
            { name: 'Clinton Powell', url: '/about/people/clinton-powell' }
          ]} />
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-gray-300 font-light leading-relaxed text-base">
              Clinton Powell founded Muse Consultancy Services (MuseCS) with a singular focus: delivering senior software engineering capability and modern software architecture to enterprise organisations across South Africa and globally.
            </p>
            <p className="text-gray-300 font-light leading-relaxed text-base">
              With extensive experience across custom software development, cloud infrastructure, and technical team augmentation, Clinton oversees MuseCS&apos;s engineering delivery standards, talent evaluation methodologies, and strategic client engagements.
            </p>
            <p className="text-gray-300 font-light leading-relaxed text-base">
